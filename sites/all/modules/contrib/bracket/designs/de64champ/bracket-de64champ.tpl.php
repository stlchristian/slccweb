 ...
 */
drupal_add_css(drupal_get_path('module', 'bracket') . '/designs/de64champ/bracket-de64champ.css', array('preprocess' => FALSE));
?>
...
<div class="bracket-block">
  ...
  <div id="round-5" class="bracket-round">
    ...
    <?php for ($i=1; $i<=count($node->round[5]->match); $i++) {
        print theme('bracket_match', array('node' => $node, 'round_index' => 5, 'match_index' => $i, 'orientation' => 'left'));
        if ($i < count($node->round[5]->match)) print '<div class="bracket-round-5-match-spacer"></div>';
    } ?>
  ...
  <div id="round-6" class="bracket-round">
    ...
    <?php for ($i=1; $i<=count($node->round[14]->match); $i++) {
        print theme('bracket_match', array('node' => $node, 'round_index' => 14, 'match_index' => $i, 'orientation' => 'left'));
        if ($i < count($node->round[14]->match)) print '<div class="bracket-round-14-match-spacer"></div>';
    } ?>
  </div>
  <div id="round-15" class="bracket-round">
    ...
    <?php for ($i=1; $i<=count($node->round[15]->match); $i++) {
        print theme('bracket_match', array('node' => $node, 'round_index' => 15, 'match_index' => $i, 'orientation' => 'left'));
        if ($i < count($node->round[15]->match)) print '<div class="bracket-round-15-match-spacer"></div>';
    } ?>
  </div>
  <div id="round-16" class="bracket-round">
    ...
    <?php for ($i=1; $i<=count($node->round[16]->match); $i++) {
        print theme('bracket_match', array('node' => $node, 'round_index' => 16, 'match_index' => $i, 'orientation' => 'left'));
        if ($i < count($node->round[16]->match)) print '<div class="bracket-round-16-match-spacer"></div>';
    } ?>
  </div>
  <div id="round-17" class="bracket-round">
    ...
    <?php print theme('bracket_match', array('node' => $node, 'round_index' => 17, 'match_index' => 1, 'orientation' => 'left')); ?>
  </div>
  <div id="round-18" class="bracket-round">
    ...
    <?php print theme('bracket_match', array('node' => $node, 'round_index' => 18, 'match_index' => 1, 'orientation' => 'left')); ?>
  </div>
